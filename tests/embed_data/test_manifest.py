"""Validate docs/addins/embed-data/manifest.xml structure and content."""
...
MANIFEST = ADDIN_MANIFEST_PATHS["embed-data"]
BASE_URL = ADDIN_BASE_URLS["embed-data"]
...
def test_extension_name_in_taskpane_js():
    ...
    js = (MANIFEST.parent / "taskpane.js").read_text()
