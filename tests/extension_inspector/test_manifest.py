"""Validate docs/addins/extension-inspector/manifest.xml structure and content."""
...
MANIFEST = ADDIN_MANIFEST_PATHS["extension-inspector"]
BASE_URL = ADDIN_BASE_URLS["extension-inspector"]
