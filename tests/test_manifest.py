"""Validate docs/manifest.xml structure and content."""

from pathlib import Path
import pytest
from lxml import etree

MANIFEST = Path(__file__).parent.parent / "docs" / "manifest.xml"
...
BASE_URL = "https://rpapub.github.io/EnfoldedOrichalcum"
